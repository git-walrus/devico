...
export function SignIn({ onNavigateHome, onNavigateSignUp }: SignInProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (email === 'demo@devico.com' && password === 'password') {
        // Success - redirect to home
        onNavigateHome();
      } else {
        setErrors({ general: 'Invalid email or password. Try demo@devico.com / password' });
      }
    } catch (error) {
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="border-0 shadow-lg">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl tracking-wide">Welcome back</CardTitle>
            <CardDescription className="text-gray-600">
              Sign in to your DevīCo account
            </CardDescription>
          </CardHeader>
